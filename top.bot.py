...
TELEGRAM_BOT_TOKEN = os.environ.get("TELEGRAM_BOT_TOKEN_RAW", "MISSING_TELEGRAM_TOKEN")
OPENROUTER_API_KEY = os.environ.get("OPENROUTER_API_KEY_RAW", "MISSING_OPENROUTER_KEY")
